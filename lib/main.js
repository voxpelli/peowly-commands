...
/** @typedef {Readonly<Record<string, Readonly<CliAlias>>>} CliAliases */
...
/** @typedef {Readonly<Record<string, Readonly<CliSubcommand>>>} CliSubcommands */

/**
 * @template {import('./flags.js').AnyFlags} Flags
 * @typedef {Readonly<import('meow').Options<Flags> & { aliases?: CliAliases, argv: readonly string[], name: string }>} CliOptions
 */
